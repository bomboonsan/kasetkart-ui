...
export const worksAPI = {
  ...
  getBook: (id) => api.get(`/work-books/${id}?populate=*&status=draft`),
  ...
  getConference: (id) => api.get(`/work-conferences/${id}?populate=*&status=draft`),
  ...
  getPublication: (id) => api.get(`/work-publications/${id}?populate=*&status=draft`),
