...
export const projectAPI = {
  ...
  getProject: (id) => api.get(`/project-researches/${getDocumentId(id)}?populate=*`),
  getProjectPartners: (projectId) => api.get(`/project-partners?populate=users_permissions_user&filters[project_researches][documentId][$eq]=${getDocumentId(projectId)}`),
  createPartner: (data) => api.post('/project-partners', { data }),
  updatePartner: (documentId, data) => api.put(`/project-partners/${getDocumentId(documentId)}`, { data }),
  deletePartner: (documentId) => api.delete(`/project-partners/${getDocumentId(documentId)}`),
  ...
  updateProject: (id, data) => api.put(`/project-researches/${getDocumentId(id)}`, { data }),
  deleteProject: (id) => api.delete(`/project-researches/${getDocumentId(id)}`)
}
...
export const fundingAPI = {
  ...
  getFunding: (id) => api.get(`/project-fundings/${getDocumentId(id)}?populate=*`),
  createFunding: (data) => api.post('/project-fundings', { data }),
  updateFunding: (id, data) => api.put(`/project-fundings/${getDocumentId(id)}`, { data }),
  deleteFunding: (id) => api.delete(`/project-fundings/${getDocumentId(id)}`)
}
