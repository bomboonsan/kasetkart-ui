...
export const projectAPI = {
  ...
  getProject: (id) => api.get(`/project-researches/${getDocumentId(id)}?populate=*&status=draft`),
  getProjectPartners: (projectId) => api.get(`/project-partners?populate=users_permissions_user&filters[project_researches][documentId][$eq]=${getDocumentId(projectId)}&status=draft`),
...
export const fundingAPI = {
  ...
  getFunding: (id) => api.get(`/project-fundings/${getDocumentId(id)}?populate=*&status=draft`),
