...
export const ME_RELATION_FIELDS_FRAGMENT = `
  fragment MeRelationFields on UsersPermissionsMe {
    documentId
    email
    username
    confirmed
...
export const GET_FILES = `
  query GetFiles($filters: UploadFileFiltersInput, $pagination: PaginationArg) {
